...
public class Home extends AppCompatActivity
    ...
    TextView popupTitle,popupDescription, popupUrl;
...
//                    pickedImgUri = clipData.getItemAt(i).getUri();  // 선택한 이미지들의 uri를 가져온다.
//                    try {
//                        popupPostImage.setImageURI(pickedImgUri);  //uri를 list에 담는다.
//
//                    } catch (Exception e) {
                            ...
                            imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Post post = new Post(popupTitle.getText().toString(),
                                            ...
                                            imageDownlaodLink,
                                            currentUser.getUid(),
                                            currentUser.getPhotoUrl()!= null ? pickedImgUri.toString() : null);
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent ShoppingActivity = new Intent(getApplicationContext(), ShoppingActivity.class);
